...
import com.icanft.common.util.UUIDGenerator;
...
//	protected ProcessOtherService processOtherService;
	...
	public List<ActivityImpl> findBackAvtivity(String taskId) throws Exception {
		...
		if (this.isJointTask(taskId)) {// 会签任务节点，不允许驳回
	...
	public void jointProcess(String taskId, List<String> userCodes)
		...
		for (String userCode : userCodes) {
			TaskEntity task = (TaskEntity) taskService.newTask(UUIDGenerator.generate(new ArrayList()));
	 ...
	 * ********************************以上为查询流程驳回节点核心逻辑**************************
	 * 
	 * **********************以下为activiti 核心service set方法***************************<br>
	 */
	...
	private ActivityImpl findActivitiImpl(String taskId, String activityId)
		...
		// 根据节点ID，获取对应的活动节点
		ActivityImpl activityImpl = ((ProcessDefinitionImpl) processDefinitionEntity)
	 ...
	 * @return
	 */
	public boolean isJointTask(String taskId) {// 会签任务节点
		return true;
	}
