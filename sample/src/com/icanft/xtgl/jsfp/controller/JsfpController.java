 ...
 * 秦墨科技有限公司
 */
package com.icanft.xtgl.jsfp.controller;
 ...
 */
@Controller
@RequestMapping(value = "/jsfp")
public class JsfpController {
	private static final Logger log = Logger.getLogger(JsfpController.class);
	 ...
	 * @return String
	 */
	@RequestMapping(value = "jsfp.do",params="lcbslb")
	@ResponseBody
	 ...
	 * @return String
	 */
	@RequestMapping(value = "jsfp.do", params = "deploy")
	@ResponseBody
	 ...
	 * @return String
	 */
	@RequestMapping(value = "jsfp.do", params = "startprc")
	@ResponseBody
