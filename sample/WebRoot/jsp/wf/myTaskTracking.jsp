    ...
    <div class="list_body">
    	<div class="list_title">
        	<table width="100%" cellpadding="0" cellspacing="0" border="0" class="top-table-systems-01-infolist-01">
                <tr>
                    <td class="top-left-systems-01-infolist-01"></td>
                    <td class="top-center-systems-01-infolist-01">业务跟踪</td>
                    <td class="top-right-systems-01-infolist-01"></td>
                </tr>
            </table>
        </div>
        <div class="center-center-systems-01-infolist-01">
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style=" border-collapse:collapse;" class="center-table-systems-01-infolist-01" >
                <tr>
                    ...
                    <td class="main-table-title013">申请人</td>
                    <td class="main-table-title013">申请时间</td>
                    <td class="main-table-title013">业务状态</td>
                    <td class="main-table-title013">流转日志</td>
                ...
                <tr height="33" valign="middle">
                    ...
                    <td>暂存</td>
                    <td><a href="javascript:void(0);">流转日志</a></td>
                    <td>
                        <a href="javascript:void(0);"><img alt="发起审批" src="<%=ctx %>/pages/fbrp/images/crud/submit.gif"/>发起审批</a>
                        <a onClick="if(!confirm('确实要删除吗?')) return false;" href="javascript:void(0);"><img alt="删除" src="<%=ctx %>/pages/fbrp/images/crud/ico-delete.gif"/>删除</a>
                    </td>
                </tr>
                <tr height="33" valign="middle">
                    <td>002</td>
